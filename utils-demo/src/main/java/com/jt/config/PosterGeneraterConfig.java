...
import com.jt.entity.vo.postGenerater.JsonAble;
import com.jt.entity.vo.postGenerater.ResourceUtils;
...
public class PosterGeneraterConfig extends JsonAble {
    ...
    public File getFontFile(String font) throws IOException {
        ...
        // 从用户自定义的目录中找
        String fontsPath = getFontsPath(font);
